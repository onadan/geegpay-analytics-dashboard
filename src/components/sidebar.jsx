...
export default function Sidebar() {
  ...
  return (
    <>
      <div className="flex h-screen fixed top-0 left-0 w-16 sm:w-20 flex-col justify-between pb-5 gap-[36px] dark:bg-neutral-900 dark:border-neutral-700 bg-[#F7F8FA] h-screen border-[#EBECF2] border pt-5 overflow-y-auto custom-scrollbar">
